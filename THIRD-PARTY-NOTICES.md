...
### 1. Version 1.0.0 inventory scope

Based on the canonical-Skill inventory as of `23 August 2026`, version `1.0.0` does not vendor or package third-party executable source libraries, binaries, OCR models, AI models, datasets, fonts, credentials, cloud connectors, or copies of official documents. JSON Schemas, methodology documents, and metadata released in the canonical Skill are Skill components only to the extent of the Owner's actual rights.
