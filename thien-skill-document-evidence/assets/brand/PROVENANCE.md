...
The single bilingual table above is controlling for filenames, dimensions, formats, transformations, and SHA-256 values. It covers the unchanged `1100`, `512`, `400`, `128`, and `64` pixel assets distributed with versions `1.0.0`, `1.1.0-rc.1`, `1.1.0-rc.2`, and `1.1.0`.
